...
def _previous_snapshot(items: list[dict]) -> dict[str, dict]:
    ...
    for item in items:
        ...
        # Only consider the deep body work reusable after the item has the new
        # narrative field. Older body-based reports are intentionally re-read so the
        # archive can be upgraded from machine-translated prose to narrative Persian.
        if (
